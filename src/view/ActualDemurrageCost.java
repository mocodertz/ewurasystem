...
public class ActualDemurrageCost extends VBox {

    protected ScrollPane actual_demurrage_view_scrollpane;
    private TableView<ActualDemurrageCostStatic> actual_demurrage_view_tableview;
    protected VBox main_content_actual_demurrage_view;
    private HBox actual_demurrage_view_table_heading_section;

    private ComboBox<String> add_day;
    private ComboBox<String> add_exchangerate_month;
    private ComboBox<String> add_actual_demurrage_factor_month;
    ...
    public ActualDemurrageCost(){
        ...
        this.add_actual_demurrage_factor_month=new ComboBox<>();
        this.add_actual_demurrage_factor_month.setPromptText("ADF Month");
        ...
        this.actual_demurrage_view_tableview = new TableView<>();
        this.actual_demurrage_view_tableview.setStyle("-fx-background-color: #eeeeee;");
        ...
        this.main_content_actual_demurrage_view = new VBox();
        this.main_content_actual_demurrage_view.setAlignment(Pos.TOP_CENTER);
        this.main_content_actual_demurrage_view.setStyle("-fx-background-color:#eeeeee;");
        this.main_content_actual_demurrage_view.setPadding(new Insets(5,5,5,5));
        this.main_content_actual_demurrage_view.setSpacing(10);
        this.main_content_actual_demurrage_view.getChildren().addAll(this.actual_demurrage_view_table_heading_section,this.actual_demurrage_view_tableview,
        ...
        this.actual_demurrage_view_scrollpane =new ScrollPane();
        this.actual_demurrage_view_scrollpane.setContent(this.main_content_actual_demurrage_view);
        this.actual_demurrage_view_scrollpane.setVbarPolicy(ScrollPane.ScrollBarPolicy.AS_NEEDED);
        this.actual_demurrage_view_scrollpane.setHbarPolicy(ScrollPane.ScrollBarPolicy.NEVER);
        this.actual_demurrage_view_scrollpane.setStyle("-fx-background-color: #eeeeee;");

        this.getChildren().add(actual_demurrage_view_scrollpane);
    }

    private void constructSurveyorCostTableView(){

        this.actual_demurrage_view_table_heading_section = new HBox();
        this.actual_demurrage_view_table_heading_section.setStyle("-fx-background-color: #085394;");
        this.actual_demurrage_view_table_heading_section.setPadding(new Insets(5,0,5,0));
        this.actual_demurrage_view_table_heading_section.setMinWidth(700);
        this.actual_demurrage_view_table_heading_section.setMinHeight(27);
        this.actual_demurrage_view_table_heading_section.setAlignment(Pos.CENTER);
        Label lbl_actual_demurrage_view_table_section = new Label("Surveyor Cost Information Table");
        lbl_actual_demurrage_view_table_section.setStyle("-fx-font-size: 13px;-fx-text-fill: white;");
        this.actual_demurrage_view_table_heading_section.getChildren().add(lbl_actual_demurrage_view_table_section);

        TableColumn<ActualDemurrageCostStatic, Integer> identity_column_actual_demurrage_view = new TableColumn<>("Identity");
        identity_column_actual_demurrage_view.setMinWidth(100);
        identity_column_actual_demurrage_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<ActualDemurrageCostStatic, Integer> date_column_actual_demurrage_view = new TableColumn<>("Date");
        date_column_actual_demurrage_view.setMinWidth(100);
        date_column_actual_demurrage_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<ActualDemurrageCostStatic, String> day_column_actual_demurrage_view = new TableColumn<>("Day");
        day_column_actual_demurrage_view.setMinWidth(100);
        day_column_actual_demurrage_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<ActualDemurrageCostStatic, String> month_column_actual_demurrage_view = new TableColumn<>("Month");
        month_column_actual_demurrage_view.setMinWidth(100);
        month_column_actual_demurrage_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<ActualDemurrageCostStatic, Integer> year_column_actual_demurrage_view = new TableColumn<>("Year");
        year_column_actual_demurrage_view.setMinWidth(100);
        year_column_actual_demurrage_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<ActualDemurrageCostStatic, Double> surveyor_cost_view_value_column = new TableColumn<>("Surveyor Cost");
        ...
        TableColumn<ActualDemurrageCostStatic, Integer> exchangerate_value_column = new TableColumn<>("Exchange Rate");
        ...
        TableColumn<ActualDemurrageCostStatic, Integer> product_value_column = new TableColumn<>("Product");
        ...
        TableColumn<ActualDemurrageCostStatic, Integer> small_vessel_value_column = new TableColumn<>("Small Vessel ATR");
        ...
        TableColumn<ActualDemurrageCostStatic, Integer> big_vessel_value_column = new TableColumn<>("Big Vessel ATR");
        ...
        TableColumn<ActualDemurrageCostStatic, Integer> conversion_factor_value_column = new TableColumn<>("Conversion Factor");
        ...
        identity_column_actual_demurrage_view.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_id"));
        date_column_actual_demurrage_view.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_date"));
        day_column_actual_demurrage_view.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_day"));
        month_column_actual_demurrage_view.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_month"));
        year_column_actual_demurrage_view.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_year"));
        surveyor_cost_view_value_column.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_value"));
        exchangerate_value_column.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_exchangerate"));
        product_value_column.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_product_id"));
        small_vessel_value_column.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_actual_demurrage_factor_small_vessel"));
        big_vessel_value_column.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_actual_demurrage_factor_big_vessel"));
        conversion_factor_value_column.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_waa_conversion_factor"));

        this.actual_demurrage_view_tableview.getColumns().addAll(identity_column_actual_demurrage_view,
                day_column_actual_demurrage_view,date_column_actual_demurrage_view,month_column_actual_demurrage_view,
                year_column_actual_demurrage_view,surveyor_cost_view_value_column,product_value_column);
    ...
    private void constructSurveyorCostViewAddingControls(){
        ...
        Label lbl_adding_section = new Label("Add Actual Demurrage Cost Information");
        ...
        hold_rowtwo_controls.getChildren().addAll(this.add_exchangerate_month,this.add_actual_demurrage_factor_month,
    ...
    public ActualDemurrageCostStatic getActualDemurrageCostStaticViewDatatobeAdded(double exchangerateValue, int exchangerate_id,
        ...
        ActualDemurrageCostStatic actualDemurrageCostStatic = null;
        ...
        if(this.add_day.getValue() !=null && this.add_date.getValue() !=null && this.add_month.getValue() !=null &&
                this.add_year.getValue() !=null && this.add_exchangerate_month !=null
            ...
            actualDemurrageCostStatic = new ActualDemurrageCostStatic(1,temp_product_id,this.add_day.getValue().toString(),
        ...
        return actualDemurrageCostStatic;
    }
    ...
    private void populateComboBoxes(){
        ...
        this.add_actual_demurrage_factor_month.setItems(null);
        ...
        this.add_actual_demurrage_factor_month.setItems(month_value);
    ...
    public String getSelectedActualDemurrageFactorMonth(){
        return this.add_actual_demurrage_factor_month.getValue().toString();
    }
    ...
    public void setActualDemurrageCostTableViewData(ObservableList<ActualDemurrageCostStatic> actualDemurrageCostStatics){
        this.actual_demurrage_view_tableview.setItems(actualDemurrageCostStatics);
    }
