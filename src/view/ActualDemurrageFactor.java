...
public class ActualDemurrageFactor extends VBox {

    protected ScrollPane actualDemurrageCost_view_scrollpane;
    private TableView<ActualDemurrageFactorStatic> actualDemurrageCost_view_tableview;
    protected VBox main_content_actualDemurrageCost_view;
    private HBox actualDemurrageCost_view_table_heading_section;
    ...
    private TextField update_actualDemurrageCost_value;
    ...
    public ActualDemurrageFactor(){
        ...
        this.update_actualDemurrageCost_value = new TextField();
        this.update_actualDemurrageCost_value.setPromptText("Exchange Rate Value");

        this.update_submit_button = new Button("Update");

        this.update_clear_button = new Button("Clear");

        this.actualDemurrageCost_view_tableview = new TableView<>();
        this.actualDemurrageCost_view_tableview.setStyle("-fx-background-color: #eeeeee;");
        ...
        constructActualDemurrageCostViewTableView();
        constructActualDemurrageCostAddingControls();
        constructActualDemurrageCostUpdatingControls();

        this.main_content_actualDemurrageCost_view = new VBox();
        this.main_content_actualDemurrageCost_view.setAlignment(Pos.TOP_CENTER);
        this.main_content_actualDemurrageCost_view.setStyle("-fx-background-color:#eeeeee;");
        this.main_content_actualDemurrageCost_view.setPadding(new Insets(5,5,5,5));
        this.main_content_actualDemurrageCost_view.setSpacing(10);
        this.main_content_actualDemurrageCost_view.getChildren().addAll(this.actualDemurrageCost_view_table_heading_section,this.actualDemurrageCost_view_tableview,
        ...
        this.actualDemurrageCost_view_scrollpane =new ScrollPane();
        this.actualDemurrageCost_view_scrollpane.setContent(this.main_content_actualDemurrageCost_view);
        this.actualDemurrageCost_view_scrollpane.setVbarPolicy(ScrollPane.ScrollBarPolicy.AS_NEEDED);
        this.actualDemurrageCost_view_scrollpane.setHbarPolicy(ScrollPane.ScrollBarPolicy.NEVER);
        this.actualDemurrageCost_view_scrollpane.setStyle("-fx-background-color: #eeeeee;");

        this.getChildren().add(actualDemurrageCost_view_scrollpane);
    }

    private void constructActualDemurrageCostViewTableView(){

        this.actualDemurrageCost_view_table_heading_section = new HBox();
        this.actualDemurrageCost_view_table_heading_section.setStyle("-fx-background-color: #085394;");
        this.actualDemurrageCost_view_table_heading_section.setPadding(new Insets(5,0,5,0));
        this.actualDemurrageCost_view_table_heading_section.setMinWidth(700);
        this.actualDemurrageCost_view_table_heading_section.setMinHeight(27);
        this.actualDemurrageCost_view_table_heading_section.setAlignment(Pos.CENTER);
        Label lbl_actualDemurrageCost_view_table_section = new Label("Actual Demurrage Cost Information Table");
        lbl_actualDemurrageCost_view_table_section.setStyle("-fx-font-size: 13px;-fx-text-fill: white;");
        this.actualDemurrageCost_view_table_heading_section.getChildren().add(lbl_actualDemurrageCost_view_table_section);

        TableColumn<ActualDemurrageFactorStatic, Integer> identity_column_actualDemurrageCost_view = new TableColumn<>("Identity");
        identity_column_actualDemurrageCost_view.setMinWidth(100);
        identity_column_actualDemurrageCost_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<ActualDemurrageFactorStatic, Integer> date_column_actualDemurrageCost_view = new TableColumn<>("Date");
        date_column_actualDemurrageCost_view.setMinWidth(100);
        date_column_actualDemurrageCost_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<ActualDemurrageFactorStatic, String> day_column_actualDemurrageCost_view = new TableColumn<>("Day");
        day_column_actualDemurrageCost_view.setMinWidth(100);
        day_column_actualDemurrageCost_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<ActualDemurrageFactorStatic, String> month_column_actualDemurrageCost_view = new TableColumn<>("Month");
        month_column_actualDemurrageCost_view.setMinWidth(100);
        month_column_actualDemurrageCost_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<ActualDemurrageFactorStatic, Integer> year_column_actualDemurrageCost_view = new TableColumn<>("Year");
        year_column_actualDemurrageCost_view.setMinWidth(100);
        year_column_actualDemurrageCost_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<ActualDemurrageFactorStatic, String> product_column_actualDemurrageCost_view = new TableColumn<>("Product");
        product_column_actualDemurrageCost_view.setMinWidth(100);
        product_column_actualDemurrageCost_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<ActualDemurrageFactorStatic, String>actualDemurrageCostVesselType = new TableColumn<>("Vessel Type");
        actualDemurrageCostVesselType.setMinWidth(100);
        actualDemurrageCostVesselType.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<ActualDemurrageFactorStatic, Double> actualDemurrageCost_view_value_column = new TableColumn<>("Demurrage Factor");
        actualDemurrageCost_view_value_column.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");
        actualDemurrageCost_view_value_column.setMinWidth(200);

        identity_column_actualDemurrageCost_view.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_id"));
        date_column_actualDemurrageCost_view.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_date"));
        day_column_actualDemurrageCost_view.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_day"));
        month_column_actualDemurrageCost_view.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_month"));
        actualDemurrageCostVesselType.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_type"));
        year_column_actualDemurrageCost_view.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_year"));
        product_column_actualDemurrageCost_view.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_product_id"));
        actualDemurrageCost_view_value_column.setCellValueFactory(new PropertyValueFactory<>("actual_demurrage_cost_value"));

        this.actualDemurrageCost_view_tableview.getColumns().addAll(identity_column_actualDemurrageCost_view,date_column_actualDemurrageCost_view,day_column_actualDemurrageCost_view,month_column_actualDemurrageCost_view,
                year_column_actualDemurrageCost_view,actualDemurrageCost_view_value_column,actualDemurrageCostVesselType,product_column_actualDemurrageCost_view);
    }
    private void constructActualDemurrageCostAddingControls(){
    ...
    private void constructActualDemurrageCostUpdatingControls(){
        ...
        hold_rowtwo_controls_update.getChildren().addAll(this.update_product,this.update_actualDemurrageCost_value);
    ...
    public ActualDemurrageFactorStatic getActualDemurrageCostDatatobeAdded(){

        ActualDemurrageFactorStatic actualDemurrageFactorStatic = null;
        int temp_product_id = 0;
        double temp_actual_demurrage_cost =0.0;
        ...
        if(this.add_day.getValue() !=null && this.add_date.getValue() !=null && this.add_month.getValue() !=null &&
            ...
            if(this.add_vessel_type.getValue().toString() =="Big Vessel"){
                temp_actual_demurrage_cost = (Double.parseDouble(this.add_days_delayed.getText()) * 23000)/(100000);

            }else if(this.add_vessel_type.getValue().toString()=="Small Vessel"){
                temp_actual_demurrage_cost = (Double.parseDouble(this.add_days_delayed.getText()) * 20000)/(40000);
            }

            actualDemurrageFactorStatic = new ActualDemurrageFactorStatic(
                    ...
                    this.add_vessel_type.getValue(),temp_actual_demurrage_cost);

        }else{
            System.out.println("You Must Fill All the Filled");
        }
        return actualDemurrageFactorStatic;
    }

    public void setActualDemurrageCostTableViewData(ObservableList<ActualDemurrageFactorStatic> actualDemurrageCost_data){
        this.actualDemurrageCost_view_tableview.setItems(actualDemurrageCost_data);
    }
    ...
    public ActualDemurrageFactorStatic getActualDemurrageCostDatatobeUpdated(){
        ActualDemurrageFactorStatic actualDemurrageCost=null;
        ...
        if(this.update_day.getValue() !=null && this.update_date.getValue() !=null && this.update_month.getValue() !=null &&
                this.update_year.getValue() !=null && this.update_actualDemurrageCost_value.getText() !=null && this.update_product !=null) {
            ...
            actualDemurrageCost = new ActualDemurrageFactorStatic(1,1,this.update_day.getValue().toString(), Integer.parseInt(this.update_date.getValue().toString()),
                    this.update_month.getValue().toString(), Integer.parseInt(this.update_year.getValue().toString()),temp_product_id,Double.parseDouble(this.update_actualDemurrageCost_value.getText()));

        } else{
            System.out.println("You Must Fill All the Filled");
        }
        return actualDemurrageCost;
    }
}
