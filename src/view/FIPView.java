...
public class FIPView extends VBox {

    protected ScrollPane fip_view_scrollpane;
    private TableView<FIP> fip_view_tableview;
    protected VBox main_content_fip_view;
    private HBox fip_view_table_heading_section;
    ...
    private TextField add_fip_value;
    ...
    private TextField update_fip_value;
    ...
    public FIPView(){
        ...
        this.add_fip_value = new TextField();
        this.add_fip_value.setPromptText("FIP Value");
        ...
        this.update_fip_value = new TextField();
        this.update_fip_value.setPromptText("Exchange Rate Value");

        this.update_submit_button = new Button("Update");

        this.update_clear_button = new Button("Clear");

        this.fip_view_tableview = new TableView<>();
        this.fip_view_tableview.setStyle("-fx-background-color: #eeeeee;");
        ...
        construct_fip_view_TableView();
        constructFIPAddingControls();
        constructFIPUpdatingControls();

        this.main_content_fip_view = new VBox();
        this.main_content_fip_view.setAlignment(Pos.TOP_CENTER);
        this.main_content_fip_view.setStyle("-fx-background-color:#eeeeee;");
        this.main_content_fip_view.setPadding(new Insets(5,5,5,5));
        this.main_content_fip_view.setSpacing(10);
        this.main_content_fip_view.getChildren().addAll(this.fip_view_table_heading_section,this.fip_view_tableview,
        ...
        this.fip_view_scrollpane =new ScrollPane();
        this.fip_view_scrollpane.setContent(this.main_content_fip_view);
        this.fip_view_scrollpane.setVbarPolicy(ScrollPane.ScrollBarPolicy.AS_NEEDED);
        this.fip_view_scrollpane.setHbarPolicy(ScrollPane.ScrollBarPolicy.NEVER);
        this.fip_view_scrollpane.setStyle("-fx-background-color: #eeeeee;");

        this.getChildren().add(fip_view_scrollpane);
    }

    private void construct_fip_view_TableView(){

        this.fip_view_table_heading_section = new HBox();
        this.fip_view_table_heading_section.setStyle("-fx-background-color: #085394;");
        this.fip_view_table_heading_section.setPadding(new Insets(5,0,5,0));
        this.fip_view_table_heading_section.setMinWidth(700);
        this.fip_view_table_heading_section.setMinHeight(27);
        this.fip_view_table_heading_section.setAlignment(Pos.CENTER);
        Label lbl_fip_view_table_section = new Label("FIP Information Table");
        lbl_fip_view_table_section.setStyle("-fx-font-size: 13px;-fx-text-fill: white;");
        this.fip_view_table_heading_section.getChildren().add(lbl_fip_view_table_section);

        TableColumn<FIP, Integer> identity_column_fip_view = new TableColumn<>("Identity");
        identity_column_fip_view.setMinWidth(100);
        identity_column_fip_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<FIP, Integer> date_column_fip_view = new TableColumn<>("Date");
        date_column_fip_view.setMinWidth(100);
        date_column_fip_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<FIP, String> day_column_fip_view = new TableColumn<>("Day");
        day_column_fip_view.setMinWidth(100);
        day_column_fip_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<FIP, String> month_column_fip_view = new TableColumn<>("Month");
        month_column_fip_view.setMinWidth(100);
        month_column_fip_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<FIP, Integer> year_column_fip_view = new TableColumn<>("Year");
        year_column_fip_view.setMinWidth(100);
        year_column_fip_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<FIP, String> product_column_fip_view = new TableColumn<>("Product");
        product_column_fip_view.setMinWidth(100);
        product_column_fip_view.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");

        TableColumn<FIP, Double> fip_view_value_column = new TableColumn<>("FIP Value");
        fip_view_value_column.setStyle("-fx-border-color:silver;-fx-background-color: whitesmoke;-fx-alignment:center;");
        fip_view_value_column.setMinWidth(200);

        identity_column_fip_view.setCellValueFactory(new PropertyValueFactory<>("fip_identity"));
        date_column_fip_view.setCellValueFactory(new PropertyValueFactory<>("fip_date"));
        day_column_fip_view.setCellValueFactory(new PropertyValueFactory<>("fip_day"));
        month_column_fip_view.setCellValueFactory(new PropertyValueFactory<>("fip_month"));
        year_column_fip_view.setCellValueFactory(new PropertyValueFactory<>("fip_year"));
        product_column_fip_view.setCellValueFactory(new PropertyValueFactory<>("fip_product"));
        fip_view_value_column.setCellValueFactory(new PropertyValueFactory<>("fip_value"));

        this.fip_view_tableview.getColumns().addAll(identity_column_fip_view,date_column_fip_view,day_column_fip_view,month_column_fip_view,
                year_column_fip_view,fip_view_value_column,product_column_fip_view);
    }
    private void constructFIPAddingControls(){
        ...
        Label lbl_adding_section = new Label("Add FIP Information");
        ...
        hold_rowtwo_controls.getChildren().addAll(this.add_product,this.add_fip_value);
    ...
    private void constructFIPUpdatingControls(){
        ...
        hold_rowtwo_controls_update.getChildren().addAll(this.update_product,this.update_fip_value);
    ...
    public FIP getFIPDatatobeAdded(){

        FIP fip = null;
        if(this.add_day.getValue() !=null && this.add_date.getValue() !=null && this.add_month.getValue() !=null &&
                this.add_year.getValue() !=null && this.add_fip_value.getText() !=null && this.add_product !=null) {
            fip = new FIP(1, this.add_day.getValue().toString(), Integer.parseInt(this.add_date.getValue().toString()),
                    this.add_month.getValue().toString(), Integer.parseInt(this.add_year.getValue().toString()),
                    this.add_product.getValue().toString(),Double.parseDouble(this.add_fip_value.getText()));
    ...
    public FIP getFIPDatatobeUpdated(){
        FIP fip=null;
        ...
        if(this.update_day.getValue() !=null && this.update_date.getValue() !=null && this.update_month.getValue() !=null &&
                this.update_year.getValue() !=null && this.update_fip_value.getText() !=null && this.update_product !=null) {
            ...
            fip = new FIP(1,this.update_day.getValue().toString(), Integer.parseInt(this.update_date.getValue().toString()),
                    this.update_month.getValue().toString(), Integer.parseInt(this.update_year.getValue().toString()),temp_product_id,Double.parseDouble(this.update_fip_value.getText()));
    ...
    public void setFIPTableViewData(ObservableList<FIP> fip_data){
        this.fip_view_tableview.setItems(fip_data);
    }
